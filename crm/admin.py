...
class Comment(admin.StackedInline):
    model = CommentCrm
    fields = ('comment_dt', 'comment_field')
...
class OrderAdmin(admin.ModelAdmin):
    ...
    search_fields = ('id', 'order_status', 'order_name', "order_phone")
...
# https://api.telegram.org/bot5531230395:AAFTyb-cebAtIPX2JmP3co1e3IK_oXEx8uc/sendMessage?chat_id=222675157&text=Test